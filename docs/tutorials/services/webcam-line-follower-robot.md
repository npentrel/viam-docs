...
<img src="/tutorials/webcam-line-follower/lf-scuttle2.png" alt="A SCUTTLE Robot base with a camera mounted on the front, pointing mostly down and slightly forwards." width="600" />
...
4. Set your robot on the line such that the line appears in the front of the camera’s view.
   ...
   <img src="/tutorials/webcam-line-follower/lf-cam-view6.png" alt="The camera view in the control tab on the robot page" width="600" />
