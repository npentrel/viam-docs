...
<img src="/tutorials/confetti-bot/install-motor-before.jpg" alt="The motor shown next to the enclosure before being installed." style="min-width:200px; max-width:275px" class="center-if-small">
<img src="/tutorials/confetti-bot/install-motor-after.jpg" alt="The motor being installed inside the enclosure with screws on top." style="min-width:200px; max-width:275px" class="center-if-small">
...
<img src="/tutorials/confetti-bot/wired-motor-driver.jpg" alt="Closeup photo of the motor driver after all the wiring to the motor, the board and the battery." style="min-width:275px; max-width:350px" class="center-if-small">

<img src="/tutorials/confetti-bot/wired-all-components.jpg" alt="Motor, motor driver, board and battery all wired to each other." style="min-width:275px; max-width:350px" class="center-if-small">
...
1. Attach the motor driver to the enclosure wall with four M2.5 x 16mm screws and M2.5 nuts.
    ...
    <img src="/tutorials/confetti-bot/install-driver-1.jpg" alt="Back view of the motor driver being installed inside the 3D printed enclosure with screws." style="min-height:275px; max-height:350px" class="center-if-small">

    <img src="/tutorials/confetti-bot/install-driver-2.jpg" alt="Front view of the motor driver being installed inside the 3D printed enclosure with screws." style="min-height:275px; max-height:350px" class="center-if-small">
...
Be careful of the wires during this so they don’t pop off.
    ...
    <img src="/tutorials/confetti-bot/install-pi-1.jpg" alt="Back view of the Raspberry Pi being installed inside the 3D printed enclosure within the designated slot." style="min-height:275px; max-height:350px" class="center-if-small">

    <img src="/tutorials/confetti-bot/install-pi-2.jpg" alt="Front view of the Raspberry Pi being installed inside the 3D printed enclosure within the designated slot." style="min-height:275px; max-height:350px" class="center-if-small">
...
Then connect the enclosure to the front panel.
    ...
    <img src="/tutorials/confetti-bot/install-cannon-front.jpg" alt="Front photo of the confetti cannon attached to the 3D printed parts." style="min-height:275px; max-height:350px" class="center-if-small">

    <img src="/tutorials/confetti-bot/install-cannon-side.jpg" alt="Side photo of the confetti cannon attached to the 3D printed parts." style="min-height:275px; max-height:350px" class="center-if-small">
...
Depending on your motor size, you may need a different screw size.
    ...
    <img src="/tutorials/confetti-bot/install-motor-holder.jpg" alt="The 3D printed black piece attached to motor with a screw securing it in place over the motor head." style="min-height:275px; max-height:350px" class="center-if-small">

    <img src="/tutorials/confetti-bot/install-cannon-holder.jpg" alt="Motor attachment with a 3D printed black piece wrapped around the confetti cannon secured over the motor head." style="min-height:275px; max-height:350px" class="center-if-small">

    <img src="/tutorials/confetti-bot/install-cannon-enclosure.jpg" alt="Motor attachment with a 3D printed black piece wrapped around the confetti cannon secured over the motor head attached to the enclosure." style="min-height:275px; max-height:350px" class="center-if-small">
...
<img src="/tutorials/confetti-bot/install-lasercut-side.jpg" alt="Lasercut side attached to the enclosure, with few cables going out of the enclosure." style="min-height:275px; max-height:350px" class="aligncenter">

### Final design

The final design, fully wired and put together looks like this:

<img src="/tutorials/confetti-bot/final-assembly-top.jpg" alt="Top view of the final assembly of the confetti cannon and 3D printed/laser cutted pieces, with a battery and a red button on a white table." style="min-height:275px; max-height:350px" class="center-if-small">

<img src="/tutorials/confetti-bot/final-assembly-side.jpg" alt="Side view of the final assembly of the confetti cannon and 3D printed/laser cutted pieces, with a battery and a red button on a white table." style="min-height:275px; max-height:350px" class="center-if-small">
